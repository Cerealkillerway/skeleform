    ...
    function traverseData(dataObject) {
        _.each(dataObject, function(fieldValue, fieldName) {
            ...
            if (!fieldSchemas[fieldName.name]) {
                ...
                let result = Skeleform.validate.checkOptions(fieldValue, fieldSchemas[fieldName.name], formSchema, item, fieldName.lang);
...
Skeleform.validate.skeleformValidateForm = function(data, fields) {
    ...
    try {
        ...
        Skeleform.validate.setInvalid(id, schema, error.result);
...
Skeleform.validate.setInvalid = function(id, schema, result) {
